...
# Reads world_pop_gdp.tsv and creates new formatted output
...
def read_gdp_data(happy_dict):
    ...
    print("Country,Population in Millions,GDP per Capita") # prints header
    ...
    for line in infile:
        ...
        print(f"{line[0]},{line[1]},{line[2]}") # output
    return
